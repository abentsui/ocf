		...
		if (vae.getComponent() instanceof EditTable) {
			...
			if ("curdToolbar".equals(id)) {
				...
				if (longReqCache != null) {
					...
					CawDialog dialog = new CawDialog("/view/erp/ocf/dialog/ocfDnUploadResultDialog.faces",
