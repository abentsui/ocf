...
public class OcfDeliveryNoteListener extends MacModuleRecordViewListener {
		...
		if (isIn(command, "printCard")) {
			...
			if (cardSize.equals("")) {
				...
				if (cardSize.equals("small")) {
					providerCode = "com.multiable.erp.ocf.ireport.provider.dn.OcfDnSmallCardProvider";
					// docReportCode = "@ocf_dnsmallcard_sql";
					docReportCode = "@btest";
				} else if (cardSize.equals("large")) {
					providerCode = "com.multiable.erp.ocf.ireport.provider.dn.OcfDnLargeCardProvider";
					docReportCode = "@ocf_dnlargecard_sql";
				}
			}
